...
ActivoTrade is a wealth management mobile application engineered with Flutter. This repository contains the mobile frontend application and the companion mock backend server for rapid validation and integration testing.
...
```text
activotrade/                       <-- Workspace Root
├── mock_api/                      <-- Mock Backend Server with Auth (JWT), User, & FCM Token endpoints
│
├── app/                           <-- Flutter Mobile Application (Package: activotrade_app)
│   ├── lib/
